...
public class RoboticArm_tools : MonoBehaviour
{
    ...
    private int force;//增大力气的系数
    private int ScrewForce;//第二关工具增强的增大扭转力的系数
    ...
    void FixedUpdate()
    {
        ...
        if (Input.GetKey("a"))
        {
            part0.AddTorque(-torque[0] * part0.mass * part0.transform.forward * force);
        }
        if (Input.GetKey("d"))
        {
            part0.AddTorque(torque[0] * part0.mass * part0.transform.forward * force);
        ...
        if (Input.GetKey("w"))
        {
            part1.AddTorque(-torque[1] * part1.mass * part1.transform.forward * force);
        }
        if (Input.GetKey("s"))
        {
            part1.AddTorque(torque[1] * part1.mass * part1.transform.forward * force);
        ...
        if (Input.GetKey("q"))
        {
            part2.AddTorque(-torque[2] * part2.mass * part2.transform.forward * force);
        ...
        if (Input.GetKey("z"))
        {
            part3.AddTorque(-torque[3] * part3.mass * part3.transform.right * force);
        }
        if (Input.GetKey("c"))
        {
            part3.AddTorque(torque[3] * part3.mass * part3.transform.right * force);
        ...
        if (grip)
        {
            gripL.AddTorque(torque[4] * gripL.mass * gripL.transform.forward * force);
            gripR.AddTorque(torque[4] * gripR.mass * gripR.transform.forward * force);
    ...
    public void exceedForce()//增大力量三倍五秒
    {
        force = 10000;
      //  part0.mass=5000;
      //part1.mass=5000;
      ...
      //torque[2] = 1000;
      //torque[3] = 1000;
        Invoke("inexceedForce", 5f);
    }

    public void inexceedForce()
    {
        part0.mass = 500;
        part1.mass = 200;
        part2.mass = 10;
    ...
    public void enlargeScrew()
    {
        rotatingScrew.mass = 500;
        Invoke("ensmallScrew", 10f);
    }

    public void ensmallScrew()
    {
        rotatingScrew.mass = 2;
    }
